  ...
  <span id="accueil"></span>
        ...
        <?php
            ...
            foreach($data['menu'] AS $fichier=>$nom){
                echo ' <li><a class="link-1" href=#'.$fichier.'> '.$nom.' </a></li>';
            }
            echo '</ul>';
        ?>
        </nav>     
